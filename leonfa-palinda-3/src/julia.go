...
// 	// Amount of work each goroutine does (8 functions)
// 	size := n/8
...
// 		}
// 		wg.Add(1)
// 		// Each goroutine does draws a column of size size in the x axis
// 		go func(i, j int) {
...
// Benchmarks
// #1 13,54 s original
// #2 9.5 with goroutines in main (one for every complexFunc)
// #3 4,71 s with goroutines and size opt in both julia and main
